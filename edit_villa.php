                ...
                <div class="col-md">
                    <div class="border border-secondary rounded bg-white p-5 my-3">
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="text" name="title" value="<?= isset($inputs['title']) ? $inputs['title'] : '' ?>" class="form-control w-75 <?= isset($errors['title']) ? 'is-invalid' : '' ?>"  id="title" placeholder="Enter Villa's title" pattern="[0-9a-zA-Z_ ]+" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="text" name="excerpt" value="<?= isset($inputs['excerpt']) ? $inputs['excerpt'] : '' ?>" class="form-control w-75 <?= isset($errors['excerpt']) ? 'is-invalid' : '' ?>"  id="excerpt" placeholder="Add excerpt" pattern="[0-9a-zA-Z_ !.,]+" required>
                ...
                <div class="col-md-6">
                    <div class="border border-secondary rounded bg-white p-5 my-3">
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <select class="custom-select w-75" id="states" name="state" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <select class="custom-select w-75" id="cities" name="city" required>
                ...
                <div class="col-md-6">
                    <div class="border border-secondary rounded bg-white p-5 my-3">
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="number" name="capacity" value="<?= isset($inputs['capacity']) ? $inputs['capacity'] : '' ?>"  class="form-control w-75 <?= isset($errors['capacity']) ? 'is-invalid' : '' ?>" id="capacity" placeholder="Set Capacity" pattern="[0-9]" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="number" name="building_area"  value="<?= isset($inputs['building_area']) ? $inputs['building_area'] : '' ?>" class="form-control w-75 <?= isset($errors['building_area']) ? 'is-invalid' : '' ?>" id="building_area" placeholder="Set Building Area" pattern="[0-9]+" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <select class="custom-select w-50" id="inlineFormCustomSelect" name="bedrooms" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            <label class=""></label>
                            <select class="custom-select w-50" id="inlineFormCustomSelect" name="bathrooms" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            <label>Price *</label>
                            <input type="number" name="price" value="<?= isset($inputs['price']) ? $inputs['price'] : '' ?>" class="form-control w-75 <?= isset($errors['price']) ? 'is-invalid' : '' ?>" id="price" placeholder="Set Price" required>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="border border-secondary rounded bg-white p-5 my-3">
                        ...
                        <textarea class="form-control" name="description" aria-label="With textarea" placeholder="Add Description" required><?= isset($inputs['description']) ? $inputs['description'] : '' ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="border border-secondary rounded bg-white p-5 my-3">
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <input type="text" name="name" value="<?= isset($inputs['name']) ? $inputs['name'] : '' ?>" class="form-control w-75 <?= isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" placeholder="Enter Name" pattern="[0-9a-zA-Z_ ]+" required>
                            </div>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="text" name="surname" value="<?= isset($inputs['surname']) ? $inputs['surname'] : '' ?>" class="form-control w-75 <?= isset($errors['surname']) ? 'is-invalid' : '' ?>" id="surname" placeholder="Enter Surname" pattern="[0-9a-zA-Z_ ]+" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="email" name="email" value="<?= isset($inputs['email']) ? $inputs['email'] : '' ?>" class="form-control w-75 <?= isset($errors['email']) ? 'is-invalid' : '' ?>" id="email" placeholder="Enter Email" required>
                        ...
                        <div class="form-group d-flex justify-content-between align-items-baseline">
                            ...
                            <input type="text" name="phone" value="<?= isset($inputs['phone']) ? $inputs['phone'] : '' ?>" class="form-control w-75 <?= isset($errors['phone']) ? 'is-invalid' : '' ?>" id="phone" placeholder="Enter Phone" pattern="[0-9]{10}" required>
